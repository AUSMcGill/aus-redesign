...
interface InvolvementPageProps {
  language: Language;
}

export function InvolvementPage({ language }: InvolvementPageProps) {
            ...
            <Card className="bg-red-50 border-red-200">
              ...
              <CardContent className="space-y-3">
                <div>
                  ...
                  <p className="text-sm text-gray-600">{t.committee1Desc}</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-1">{t.committee2}</h4>
                  <p className="text-sm text-gray-600">{t.committee2Desc}</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-1">{t.committee3}</h4>
                  <p className="text-sm text-gray-600">{t.committee3Desc}</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-1">{t.committee4}</h4>
                  <p className="text-sm text-gray-600">{t.committee4Desc}</p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{t.opportunity1Desc}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Calendar className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{t.opportunity2Desc}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Calendar className="w-5 h-5 text-blue-600 mt-0.5 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{t.opportunity3Desc}</p>
                  </div>
                </div>
